            ...
            <div class="flex items-center space-x-8">
               ...
               <div class="relative group z-10">
                  ...
                  >
                     <a
                        href="#"
                        class="block px-6 py-2 text-sm hover:bg-neutral-20"
                        >Español</a
                     >
                     <a
                        href="#"
         ...
         <div class="flex h-23 items-center justify-between">
            ...
            <a href="./index.html" target="_blank">
               <div class="flex items-center space-x-2">
                  ...
                  ></div>
                  <span class="font-bold text-3xl md:text-4xl lg:text-5xl"
                     >Logo</span
                  >
               </div>
            </a>
            ...
            <div class="hidden items-center space-x-5 md:flex">
               ...
               <div class="relative group">
                  <button
                     class="px-4 py-2 flex items-center hover:text-secondary-20-dark focus:outline-none focus:text-primary-10-light md:text-lg lg:text-xl/6"
                  >
                     Sobre Nosotros
                     <svg
                        class="ml-2 h-4 w-4"
                  ...
                  >
                     <a
                        href="#"
                        class="block px-8 py-2 text-sm hover:bg-neutral-20"
                        >Historia</a
                     >
                     <a
                        href="#"
   ...
   >
      ...
      <nav class="space-y-4 p-4 font-medium my-4">
         ...
         <div>
            ...
            <div
               id="dropdownMenuMobileLanguage"
               class="hidden pl-4 space-y-3 mt-2"
            >
               <a
                  href="#"
      ...
      <div class="main-content pt-24">
         ...
         >
            <div class="space-y-15">
               <h1
                  class="text-4xl md:text-6xl lg:text-18/20 text-heading font-medium"
               >
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit
               </h1>
               <div class="p-12 bg-gray-100 rounded">
                  <h3
                     class="md:text-lg lg:text-xl/6 font-medium mb-2 uppercase text-opacities-dark-05"
                  >
                     Referencia
                  </h3>
                  <h2
                     class="text-sm md:text-base lg:text-lg/5 font-normal uppercase text-neutral-40"
                  >
                     Modelo X
                  </h2>
                  ...
                  <ul class="list-disc list-inside text-sm space-y-1">
                     <li class="text-neutral-40">
                        <span
                           class="text-neutral-60 font-normal text-xs md:text-sm lg:text-base/5"
         ...
         <section id="advantage" class="mb-24 p-24">
            <div class="max-w-5xl mx-auto text-center">
               <!-- Title -->
               <h2
                  class="mb-24 font-medium text-3xl md:text-4xl lg:text-12-5/15 text-primary-40-light"
               >
                  Ventajas
               </h2>
               ...
               >
                  ...
                  <div class="flex flex-col items-center text-center">
                     ...
                     />
                     <span
                        class="font-medium text-xs md:text-sm lg:text-base/5 text-neutral-60"
                        >640 zonas</span
                     >
                  </div>
         ...
         <section id="accessory" class="mb-24 py-24 pt-24 pb-36">
            <div class="text-center">
               <h2
                  class="mb-24 font-medium text-3xl md:text-4xl lg:text-12-5/15 text-center text-primary-40-light"
               >
                  Accesorios
               </h2>
            </div>
            ...
            >
               ...
               >
                  ...
                  <div class="bg-neutral-05 p-6 rounded">
                     <p
                        class="mb-2 font-medium text-base md:text-lg lg:text-xl/6 font-roboto-condensed uppercase text-shadow-opacities-dark-05"
                     >
                        Referencia
                     </p>
                     <p
                        class="font-roboto-condensed font-normal text-sm md:text-base lg:text-lg/5 uppercase text-neutral-40"
                     >
                        Modelo
                     </p>
                  </div>
                  <p
                     class="mt-6 font-normal text-base/6 text-neutral-60 truncate"
                  >
                     Lorem ipsum dolor sit amet, consectetur adipiscing elit,
         ...
         >
            <h2
               class="text-4xl md:text-6xl lg:text-18/20 font-medium text-heading"
            >
               Lorem Ipsum passage
            </h2>
            <p
               class="my-24 text-primary-40-light font-medium text-3xl md:text-4xl lg:text-12-5/15"
            >
               The standard used since the 1500s
            </p>
            <p class="font-normal text-lg md:text-xl lg:text-2xl/10">
         ...
         >
            ...
            <p
               class="mb-24 px-6 text-primary-40-light font-medium text-3xl md:text-4xl lg:text-12-5/15 text-center"
            >
               Lorem Ipsum
            </p>
            <li
            ...
            >
               ...
               <span class="text-neutral-80 font-normal">
                  ed ut perspiciatis unde omnis iste natus error sit voluptatem
                  accusantium doloremque laudantium, totam rem aperiam, eaque
                  ipsa quae ab illo inventore veritatis et quasi architecto
                  beatae vitae dicta sunt explicabo.
         ...
         <section id="table" class="mb-24 max-w-7xl py-24 px-4 mx-auto">
            <!-- Heading -->
            <h2
               class="text-center font-medium text-3xl md:text-4xl lg:text-12-5/15 text-primary-40-light mb-24 mx-auto"
            >
               Tabla comparativa
            </h2>
            ...
            <div class="mb-6">
               ...
               <div class="overflow-x-auto">
                  <table class="min-w-sm border-collapse mx-auto">
                     <thead>
                        <tr
                           class="bg-primary-00 text-neutral-05 text-lg md:text-2xl lg:text-9-5/11 font-semibold"
                        >
                           <th class="text-left p-6 rounded-tl-lg">
                              Beneficios
                           </th>
                     ...
                     <tbody class="bg-primary-light">
                        <!-- Row 1 -->
                        <tr
                           class="border-b border-primary-60-light text-base md:text-xl lg:text-7/9.5 font-semibold"
                        >
                           <td class="my-3 py-3 px-3 text-left text-neutral-60">
                              Beneficio A
                           </td>
                           <td
                              class="text-center my-3 py-3 px-3 text-green-500"
                           >
               ...
               <!-- Notes -->
               <div
                  class="mt-6 space-y-3 font-medium text-sm md:text-base lg:text-xl/6 text-neutral-60"
               >
         ...
         <section id="form" class="mx-auto my-24 max-w-5xl pt-24 px-4 pb-36">
            <div class="my-6">
               ...
               >
                  <h2 class="mb-6 text-lg font-bold text-primary-00">
                     Formulario
                  </h2>
                  <form
                     id="contactForm"
                  ...
                  >
                     ...
                     <label
                        ...
                        >Estoy interesado en el Partner Program<span
                           >&#42;</span
                        ></label
                     >
                     <textarea
                     ...
                     >
                        ...
                        <span class="mb-6 md:mb-12 text-neutral-60">
                           Doy mi consentimiento para el tratamiento de mis
                           datos personales.
                           <a
                              href="#"
      ...
      >
         ...
         <div class="space-y-4 text-center md:text-left">
            ...
            >
               ...
               >
                  <img
                     src="./images/available_on_the_app_store_apple_button-min-modified-min.png"
                     alt="App Store"
                     class="h-11 w-32"
                  />
               </a>
